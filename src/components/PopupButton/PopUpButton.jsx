...
const PopUpButton = ({ onLoginClick, isAuthVisible }) => {
    ...
    useEffect(() => {
        ...
        const handleScroll = () => {
            ...
            // Hiển thị khi scroll xuống 1000px và ẩn khi xuống 1300px
            if (currentScrollY > 1500 && currentScrollY <= 2500) {
                setIsVisible(true)
            } else {
                setIsVisible(false)
            }
    ...
    return (
        <div className={`${styles.popupWrapper} ${isVisible ? styles.visible : ''}`} onClick={onLoginClick}>
            <div className={styles.tooltipContainer}>
				...
				c0,0,17.8,28.2,42,18.3C217.2,118.7,204.4,102.4,199,87.1z"
					...
					C165.3,85.5,163.8,85.9,162.7,86.5z"
                                    ...
                                    <path
                                        ...
                                        d="M161.6,80.6c0,0,0.5-0.4,0.7-1.2C173.6,82.3,167.8,82.9,161.6,80.6z"
                                    ></path>
                                    <path
                                        id="eye_x5F_right"
                                        className={styles.st5}
				...
				c0.9,0.8,2.4,2.6,2.4,2.6C246.5,130.9,245.2,128.4,244.9,127.7z"
                                ></path>
                                <g>
                                    <path className={styles.st9} d="M240.6,137.4h0.1l0,0H240.6z"></path>
                                    <path
                                        className={styles.st3}
			...
			C132.5,35.9,144.9,22.1,158.6,21.9z"
                            ></path>
                            <ellipse className={styles.st15} cx="127.2" cy="65.8" rx="4.1" ry="12.4"></ellipse>
                        </g>
                    </g>
                </svg>
            </div>
