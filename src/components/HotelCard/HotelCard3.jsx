...
const HotelCard3 = ({ hotel, aosDelay }) => {
  ...
  // Tính rating
  const rating = ((hotel?.hotel_class || 0) / 10).toFixed(1);
  ...
  const amenities = getAmenities(hotel?.amenities).slice(0, 4);

  // Lấy styles
  const hotelStyles = hotel?.styles
    ? hotel.styles.map((style) => style.style).slice(0, 2)
    : [];
  ...
  const formatPrice = (price) => {
    return Number.parseInt(price || 0, 10).toLocaleString("vi-VN");
  };
          ...
          >
            ...
            <div style={styles.topBadges}>
              ...
              {hotelStyles.length > 0 && (
                <div style={styles.styleBadge}>{hotelStyles[0]}</div>
              )}
            </div>
        ...
        <div style={styles.content}>
          ...
          <div style={styles.header}>
            <div style={styles.location}>
              ...
              ></i>
              <span
                style={{ color: "#888", fontSize: "13px", fontWeight: "500" }}
              >
                {hotel?.province}
              </span>
            </div>
          ...
          <h3 style={styles.hotelName}>
            <Link
              ...
              style={{
                ...styles.hotelLink,
                color: isHovered ? "#FFD700" : "inherit",
              }}
            >
              {hotel?.name}
            </Link>
          ...
          <div style={styles.description}>
            <p style={{ margin: 0, lineHeight: "1.5", fontSize: "14px" }}>
              ...
              {(hotel?.description?.length || 0) > 120 && "..."}
            </p>
          </div>
            ...
            <div style={styles.priceSection}>
              ...
              <div style={styles.priceContainer}>
                ...
                <span style={styles.priceValue}>
                  {formatPrice(hotel?.price || "2000000")}
                </span>
...
HotelCard3.propTypes = {
  hotel: PropTypes.shape({
    id: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
    name: PropTypes.string,
    hotel_class: PropTypes.number,
...
const styles = {
  ...
  imageOverlay: {
    ...
    height: "60%",
    background:
      "linear-gradient(to top, rgba(30,30,30,0.9) 0%, transparent 100%)",
    pointerEvents: "none",
  },
  secondaryImage: {
    position: "absolute",
