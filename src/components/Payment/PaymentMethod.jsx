    ...
    useEffect(()=>{
        const fechPayment=async()=>{
            try {
                ...
                //Tính tổng tiền
                const total = data.data.reduce((sum, payment) => sum + Number(payment.amount), 0);
        ...
        <div className={content} style={{marginBottom:'50px'}}>
            <div className={contentLeft}>
                ...
                >
                    ...
                    <div style={{fontSize:'36px',fontWeight:'bold',color:'darkgray'}}>{formatVND(totalAmount)}</div>
                </div>
                <div style={{
                    display: 'flex',
                                    ...
                                    <div className={content_transaction}>
                                        <div className={content_transaction_left}>
                                            ...
                                            <div>
                                                ...
                                                <div>{payment.status === 'completed' ? 'Completed' : 'Pending'}</div>
                                            </div>
                                        </div>
            ...
            <div className={contentRight}>
                ...
                <div className={content_refund}>
                    ...
                    <div style={{color:'#d9d9d9',display:'flex',justifyContent:'center',gap:'5px',fontSize:'28px'}}>{formatVND(user?.wallet_balance)}  &#8645;</div>
                </div>
