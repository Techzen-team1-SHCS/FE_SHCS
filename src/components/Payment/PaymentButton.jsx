...
const PaymentButton = ({ amount, bookingInfo }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const authResponse = await axios.post('https://beshcs-production.up.railway.app/api/payment/authenticate', {
      ...
      if (authResponse.data.success) {
        ...
        const otpResponse = await axios.post('https://beshcs-production.up.railway.app/api/payment/send-otp', {
          phoneNumber: phoneNumber,
        });
  ...
  const handleCompletePayment = async (otpCode) => {
    ...
    try {
      ...
      const response = await axios.post('https://beshcs-production.up.railway.app/api/payment/verify-otp', payload);
